...
public class ContadordeIndice {
    public static void main(String[] args) {
        Set<String> palabrasOmitidas = new HashSet<>(Arrays.asList(
                "el", "la", "los", "las", "un", "una", "unos", "unas", "es", "en", "para", "de", "y", "con", "se", "por",
                "del", "al", "es", "un", "una", "lo", "le", "me", "te", "a", "son", "como", "no", "su", "que"
        ));
